...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.avgTimeStart = QLineEdit(self.layoutWidget1)
        ...
        self.avgTimeEnd = QLineEdit(self.layoutWidget1)
        ...
        self.diffBikes = QLineEdit(self.layoutWidget1)
        ...
        self.rentalsList = QListWidget(self.layoutWidget1)
